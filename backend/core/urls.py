...
router.register(r'user-submissions', UserSubmissionViewSet)
...
urlpatterns = [
    ...
    path('certificates/<int:module_id>/download/', CertificateDownloadView.as_view(), name='certificate_download'),
